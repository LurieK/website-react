...
import pomedoro_mov from '../video/pomedoro.mov'; 
...
const ProjectsObj = [
    ...
    },
    {
        title: `Pomedoro App`,
        mainImage: pomedoro,
        summary1: `The inspiration for this project stemed from curiosity about useState.  I wondered since one state could be used to manage multiple events in React what would happen if I used a count down timer, managed in state, to set off a alarm, and restart a new timer. 
        ...
        summary2: `In the initial stages of building the app, the primary focus was creating a functioning timer. This was achieved using a single state, countDownTime, to track the time.  This worked alongside a useEffect hook that implemented setInterval for the countdown rednered on the screen. This setup effectively managed one timer, and set an alarm off, yet another state was needed to switch between counting down from 25 minutes or 5 minutes, which is the standard practice in a pomedoro app. 
