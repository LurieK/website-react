...
const ProjectsObj = [
    ...
    },
    {
    ...
    },
     {
        ...
        summary2: `The first step in this evolution was moving the API key to a separate .env file and establishing a Node.js server using Express.js. This setup allowed me to create internal endpoints for **handling asynchronous requests securely and efficiently**. By keeping client-side DOM manipulation and API request handling separate, the project aso gained clarity and efficiency. While I hadn’t considered this in the beginning making the project modulate also enabled me to move the cards data into its own file, further modularizing the project.`,
